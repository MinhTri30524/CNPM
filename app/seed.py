...
from app.models import HocSinh, GiangVien, UserRole, LoaiDiemEnum, Hoc, Diem, HocKy, DeCuongMonHoc
...
if __name__ == '__main__':
	with app.app_context():
		...
		# Thêm dữ liệu De_Cuong_Mon_Hoc
		# de_cuong_1 = DeCuongMonHoc(khoi_id=1, mon_hoc_id=1,
		# 							 loai_diem=LoaiDiemEnum.KIEM_TRA_15_PHUT, so_cot=15)
		# de_cuong_2 = DeCuongMonHoc(khoi_id=2, mon_hoc_id=1,
		# 							loai_diem=LoaiDiemEnum.KIEM_TRA_15_PHUT, so_cot=10)
		# de_cuong_3 = DeCuongMonHoc(khoi_id=1, mon_hoc_id=3,
		# 							loai_diem=LoaiDiemEnum.CUOI_KY, so_cot=15)
		# db.session.add_all([de_cuong_1, de_cuong_2, de_cuong_3])
